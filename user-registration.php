...
var domain=x.slice((atpos+1),x.length);

if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length || domain!="cybage.com" )
  {
  alert("Not a valid Cybage e-mail address");
  return false;
  }
  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td align="center" valign="top">		<div align="left">
        <p><span class="style7">User Registration</span></p>
        <p>Please enter the following information to register:</p>
        <form name="form1" method="post" action="register.php" onsubmit="return validateForm();" method="post">
          <p>Username:<br>
